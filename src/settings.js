 ...
 * @property {Object} [settings.conversationViewWidths={small: 320, medium: 480, large: 640}] The widths that the Conversation View must be for it to transition to the rendering associated with a new class of size
 * @property {Number} [settings.conversationViewWidths.small=320] If width is less than this, use `layer-conversation-view-width-tiny` css class
 * @property {Number} [settings.conversationViewWidths.medium=480] If width is less than this, use `layer-conversation-view-width-small` css class
 * @property {Number} [settings.conversationViewWidths.large=640] If width is less than this, use `layer-conversation-view-width-medium` css class
