...
const svg = () => `<svg class="layer-svg-media-player-mute" width="100%" height="100%" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:bevel;stroke-miterlimit:1;">
    <g transform="matrix(2,0,0,2,0,0)">
        ...
        <path class="layer-svg-strokable"  d="M3.8,4.5C4.656,5.395 19.7,19 19.7,19" style="fill:none;stroke-width:1.5px;"/>
    </g>
</svg>`;

register({ svg, role: 'media-player-mute' });
