...
class SyncManager extends Root {
  ...
  _xhrSuccess(result) {
    ...
    if (result.data) logger.debug('Sync-Manager: Success data', result.data);
 ...
 * @property {Layer.Core.Websockets.RequestManager} requestManager
 */
 ...
 * @property {Layer.Core.SyncEvent[]} queue
 */
 ...
 * @property {Layer.Core.SyncEvent[]} receiptQueue
 */
 ...
 * @property {Number} [MAX_UNAVAILABLE_RETRY_WAIT=60]
 * @static
 */
 ...
 * @property {number} [MAX_RETRIES_BEFORE_CORS_ERROR=3]
 * @static
 */
 ...
 *
 * @property {number} [MAX_RETRIES=20]
 * @static
 */
